...
import { type PacienteFormData } from '../schemas/pacienteSchema';
...
export const createPaciente = async (paciente: PacienteFormData) => (await api.post<Paciente>('/pacientes', paciente)).data;
...
export const updatePaciente = async (id: string, paciente: PacienteFormData) => (await api.patch<Paciente>(`/pacientes/${id}`, paciente)).data;
